...
/***/ function(module, exports, __webpack_require__) {
	...
	var _globalRouter = __webpack_require__(44);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _routesMail = __webpack_require__(43);
...
/***/ function(module, exports, __webpack_require__) {
	    ...
	    value: function render() {
	      return React.createElement(
	        ...
	        React.createElement(
	          NavBrand,
	          { tabIndex: '-1' },
	          React.createElement('img', { src: '/imgs/ucm4.svg', alt: 'rubix', width: '260', height: '45' })
	        )
	      );
	    }
	  }]);
	  ...
	  render: function render() {
	    switch (this.props.className) {
	      ...
	      case 'dropdown-header':
	        return React.createElement(
	          'li',
	          { role: 'presentation', className: this.props.className },
	          this.props.children
	        );
	      default:
	        return React.createElement(
	          ...
	          React.createElement(
	            'a',
	            { role: 'menuitem', tabindex: this.props.index, href: this.props.url },
	            this.props.children
	          )
	        );
	    };
	...
	var Dropdown = React.createClass({
	  ...
	  render: function render() {
	    if (typeof this.props.label != 'string') this.props.label = '';
	    return React.createElement(
	      'div',
	      { className: 'dropdown' },
	      React.createElement(
	        Button,
	        { className: 'dropdown-toggle ' + this.props.className, id: this.props.label.replace(/\s+/g, ''), 'data-toggle': 'dropdown' },
	        this.props.label,
	        React.createElement('span', { className: 'caret' })
	      ),
	      React.createElement(
	        'ul',
	        { className: 'dropdown-menu', role: 'menu', 'aria-labelledby': this.props.label.replace(/\s+/g, '') },
	        this.props.children
	      )
	    );
	  }
